...
<!-- ============================
     PRODUK SECTION
     ============================ -->
<section id="produk" class="py-24 px-6 bg-[#0a0a0a]">
    <div class="max-w-7xl mx-auto">
        <!-- Section Header -->
        <div class="text-center mb-16">
            <p class="section-subtitle mb-3">✦ Menu Kami ✦</p>
            <h2 class="section-title mb-4">Koleksi Premium</h2>
            <div class="gold-divider"></div>
            <p class="text-[#f7e080]/60 mt-4 max-w-xl mx-auto">Setiap produk dibuat segar setiap hari dengan bahan-bahan terpilih. Pilih favorit Anda dan pesan langsung.</p>
        </div>
            ...
            <div class="card-product group" id="product-{{ $product->id }}">
                ...
                <div class="relative overflow-hidden aspect-[4/3] rounded-t-2xl">
                    ...
                    <div class="absolute top-4 left-4">
                        <span class="bg-[#d4af37]/90 text-[#0a0a0a] text-[10px] font-bold tracking-widest uppercase px-4 py-1.5 rounded-full shadow-lg">
                            {{ ucfirst($product->category) }}
                        </span>
                    </div>
                    <!-- Price Badge -->
                    <div class="absolute bottom-4 right-4">
                        <span class="bg-[#0a0a0a]/80 border border-[#d4af37]/40 text-[#d4af37] text-sm font-bold px-4 py-1.5 rounded-full backdrop-blur-sm shadow-lg" style="font-family:'Cormorant Garamond',serif;">
                ...
                <div class="p-6 relative z-10">
                    <h3 class="text-xl font-bold text-[#d4af37] mb-2" style="font-family:'Cormorant Garamond',serif;">{{ $product->name }}</h3>
                    <p class="text-sm text-[#f3e9c6]/60 leading-relaxed mb-6 line-clamp-2">{{ $product->description }}</p>
                    <button
                        onclick="openOrderModal({{ $product->id }}, '{{ addslashes($product->name) }}', {{ $product->price }}, '{{ $product->formatted_price }}')"
                        class="btn-gold w-full py-3.5 text-[11px] shadow-lg shadow-[#d4af37]/20">
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1 flex flex-col gap-4">
                <div class="bg-[#141414] border border-[#d4af37]/15 p-6 hover:border-[#d4af37]/40 transition-colors duration-300">
                    <div class="w-12 h-12 border border-[#d4af37]/30 flex items-center justify-center mb-4 text-2xl">📍</div>
                    <h4 class="text-[#d4af37] font-semibold mb-2" style="font-family:'Cormorant Garamond',serif;">Lokasi</h4>
                    <p class="text-sm text-[#f7e080]/60">Jl. Banjarmasin Blok O/15 Asratek,Ulak Karang Selatan,Padang Utara</p>
                </div>
                <div class="bg-[#141414] border border-[#d4af37]/15 p-6 hover:border-[#d4af37]/40 transition-colors duration-300">
                    <div class="w-12 h-12 border border-[#d4af37]/30 flex items-center justify-center mb-4 text-2xl">📞</div>
                    <h4 class="text-[#d4af37] font-semibold mb-2" style="font-family:'Cormorant Garamond',serif;">Telepon & WhatsApp</h4>
                    <p class="text-sm text-[#f7e080]/60">0852-6375-2742</p>
                    <a href="https://wa.me/6281234567890" target="_blank" class="text-xs text-[#d4af37] hover:underline mt-1 inline-block">Chat via WhatsApp →</a>
                </div>
                <div class="bg-[#141414] border border-[#d4af37]/15 p-6 hover:border-[#d4af37]/40 transition-colors duration-300">
                    <div class="w-12 h-12 border border-[#d4af37]/30 flex items-center justify-center mb-4 text-2xl">🕐</div>
                    <h4 class="text-[#d4af37] font-semibold mb-2" style="font-family:'Cormorant Garamond',serif;">Jam Operasional</h4>
                    <div class="text-sm text-[#f7e080]/60 space-y-1">
